    ...
    render = () => {
        return (
            <div className="container" id="about-container">
                ...
                <p>Hi, I’m a professional software engineer motivated by helping others realize their full potential and creating simple yet effective solutions to big picture problems.</p>
                <br/>
                ...
                <br/>
                <p>I’m also a recent software engineering bootcamp grad who’s decided to turn a long time passion and hobby into a new career path.  I’ve built numerous full stack applications that are centered around a simple, intuitive user experience and clearly organized code.  I’m fluent in all the major frontend technologies and have experience building with frameworks like React and Vue.  On the backend, I’ve built projects using Node/Express.js, Ruby on Rails, and Java/Spring.</p>
            </div>
        )
    }
}
