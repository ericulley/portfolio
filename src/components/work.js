    ...
    return (
      <div className="container" id="work-container">
        ...
        <div id="project-container">
          ...
          <div className="projects">
            <h3>
              <a className="work-link" href="https://personal-backlog.vercel.app/" target="_blank">
                Personal Backlog
              </a>
            </h3>
          ...
          <div className="projects">
            <h3>
              <a className="work-link" href="http://34.209.125.229" target="_blank">
                I'm Outdoorsy
              </a>
            </h3>
            <em>Technologies: Node.js/Express, Cloudinary API</em>
            <p>A social media app for the outdoorsy</p>
            <a href="https://github.com/ericulley/ImOutdoorsy" target="_blank">
              <img className="github-img" src={process.env.PUBLIC_URL + "/GitHub.png"} alt="github-logo" />
            </a>
          </div>
          <div className="projects">
            <h3>
              <a className="work-link" href="https://ericulley.github.io/AltFuel/" target="_blank">
                AltFuel
              </a>
            </h3>
            <em>Technologies: HTML/CSS/JS, jQuery</em>
            <p>A fuel finder app for electric charging stations</p>
            <a href="https://github.com/ericulley/AltFuel" target="_blank">
              <img className="github-img" src={process.env.PUBLIC_URL + "/GitHub.png"} alt="github-logo" />
            </a>
          </div>
        </div>
